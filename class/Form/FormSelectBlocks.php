 ...
 * @access      public
 */
class FormSelectBlocks extends \XoopsFormElement
{
    /**
     * Options
     *
    ...
    public function __construct($caption, $name, $value = null, $size = 1, $multiple = false)
    {
        ...
        foreach ($this->getBlocks() as $id => $title) {
    ...
    public function getBlocks()
    {
        ...
        $blocks       = $blockHandler->getObjects(null, true);
        foreach ($blocks as $id => $block) {
            $langs_array[$id] = \xcontent_getBlockTitle($id);
        }
