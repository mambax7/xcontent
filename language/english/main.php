...
// EDIT BLOCK FORM
define('_XCONTENT_AD_NEWBLOCK', 'Create New Linked Block');
define('_XCONTENT_AD_EDITBLOCK', 'Edit The Linked Block');
define('_XCONTENT_AD_OPENDESCRIPTION', 'Reference');
define('_XCONTENT_AD_OPENDESCRIPTION_DESC', 'This is what you refer the block to');
define('_XCONTENT_AD_BLOCKHTML', 'BLOCK Code');
define('_XCONTENT_AD_BLOCKHTML_DESC', 'HTML/XCODE/TEXT Code for linked block');
...
define('_XCONTENT_AD_INHERITBLOCK', 'Linked Block');
...
define('_XCONTENT_AD_INHERITBLOCK_DESC', 'Linked block for page');
