...
/** @var ContentHandler $xcontentHandler */
...
switch ($op) {
    case _XCONTENT_URL_OP_ABOUT:
        ...
        $adminObject->displayNavigation(basename($_SERVER['SCRIPT_NAME']) . '?op=' . $op);
...
<!-- End Form Validation JavaScript //-->',
            ...
            switch ($key) {
                case 2:
                    $donationform[$key] = sprintf(
                        ...
                        XOOPS_LICENSE_KEY,
                        mb_strtoupper($GLOBALS['xcontentModule']->getVar('dirname')),
                        mb_strtoupper($GLOBALS['xcontentModule']->getVar('dirname')) . ' ' . $GLOBALS['xcontentModule']->getVar('name')
                    );
                    break;
            }
        }
    ...
    case _XCONTENT_URL_OP_SAVE:
        switch ($fct) {
            case _XCONTENT_URL_FCT_PAGES:
                ...
                redirect_header('main.php?op=' . _XCONTENT_URL_OP_MANAGE . '&fct=' . _XCONTENT_URL_FCT_XCONTENT, 7, _XCONTENT_MSG_XCONTENTSAVED);
                break;
            case _XCONTENT_URL_FCT_CATEGORIES:
                ...
                redirect_header('main.php?op=' . _XCONTENT_URL_OP_MANAGE . '&fct=' . _XCONTENT_URL_FCT_CATEGORIES, 7, _XCONTENT_MSG_XCONTENTSAVED);
                break;
            case _XCONTENT_URL_FCT_BLOCKS:
                ...
                if ($blockHandler->insert($block['block'])) {
                    ...
                    if ($textHandler->insert($block['text'])) {
                        redirect_header('main.php?op=' . _XCONTENT_URL_OP_MANAGE . '&fct=' . _XCONTENT_URL_FCT_BLOCKS, 6, _XCONTENT_MSG_BLOCKSAVED);
                    } else {
                        redirect_header('main.php?op=' . _XCONTENT_URL_OP_MANAGE . '&fct=' . _XCONTENT_URL_FCT_BLOCKS, 6, _XCONTENT_MSG_BLOCKNOTSAVED);
                    }
                } else {
                    redirect_header('main.php?op=' . _XCONTENT_URL_OP_MANAGE . '&fct=' . _XCONTENT_URL_FCT_BLOCKS, 6, _XCONTENT_MSG_BLOCKNOTSAVED);
                }
            ...
            case _XCONTENT_URL_FCT_CATEGORY:
                ...
                if ($categoryHandler->insert($category['cat'])) {
                    ...
                    if ($textHandler->insert($category['text'])) {
                        redirect_header('main.php?op=' . _XCONTENT_URL_OP_MANAGE . '&fct=' . _XCONTENT_URL_FCT_CATEGORIES, 6, _XCONTENT_MSG_CATEGORYSAVED);
                    } else {
                        redirect_header('main.php?op=' . _XCONTENT_URL_OP_MANAGE . '&fct=' . _XCONTENT_URL_FCT_CATEGORIES, 6, _XCONTENT_MSG_CATEGORYNOTSAVED);
                    }
                } else {
                    redirect_header('main.php?op=' . _XCONTENT_URL_OP_MANAGE . '&fct=' . _XCONTENT_URL_FCT_CATEGORIES, 6, _XCONTENT_MSG_CATEGORYNOTSAVED);
                }
            ...
            case _XCONTENT_URL_FCT_XCONTENT:
                ...
                if (file_exists($GLOBALS['xoops']->path('modules/tag/class/tag.php')) //TODO Tags
                ...
                if (true === $newObject) {
                    /** @var \XoopsGroupPermHandler $groupperm */
                ...
                redirect_header('main.php?op=' . _XCONTENT_URL_OP_EDIT . '&fct=' . _XCONTENT_URL_FCT_XCONTENT . '&storyid=' . $xcontent['xcontent']->getVar('storyid') . '&language=' . $xcontent['text']->getVar('language'), 7, _XCONTENT_MSG_XCONTENTSAVED);
                break;
        }
        break;
    case _XCONTENT_URL_OP_EDIT:
        switch ($fct) {
            case _XCONTENT_URL_FCT_XCONTENT:
                xoops_cp_header();
                $adminObject = Admin::getInstance();
                $adminObject->displayNavigation(basename($_SERVER['SCRIPT_NAME']) . '?op=' . $op . '&fct=' . $fct);
                ...
                if (Request::hasVar('language', 'GET')) {
        ...
        switch ($fct) {
            case _XCONTENT_URL_FCT_XCONTENT:
                ...
                if (0 == $categoryHandler->getCount(null)) {
                    redirect_header('main.php?op=' . _XCONTENT_URL_OP_ADD . '&fct=' . _XCONTENT_URL_FCT_CATEGORIES, 6, _XCONTENT_NEEDCATEGORIES);
                }
    ...
    case _XCONTENT_URL_OP_DELETE:
        switch ($fct) {
            case _XCONTENT_URL_FCT_XCONTENT:
                ...
                redirect_header('main.php?op=' . _XCONTENT_URL_OP_MANAGE . '&fct=' . _XCONTENT_URL_FCT_XCONTENT, 7, _XCONTENT_AD_MSG_DELETE);
                break;
            case _XCONTENT_URL_FCT_CATEGORY:
                if (empty($_POST['confirmed'])) {
                    xoops_cp_header();
                ...
                @$GLOBALS['xoopsDB']->queryF($sql[0]);
                @$GLOBALS['xoopsDB']->queryF($sql[1]);
                redirect_header('main.php?op=' . _XCONTENT_URL_OP_MANAGE . '&fct=' . _XCONTENT_URL_FCT_CATEGORIES, 7, _XCONTENT_AD_MSG_DELETE);
                break;
            case _XCONTENT_URL_FCT_BLOCKS:
                if (empty($_POST['confirmed'])) {
                    xoops_cp_header();
                ...
                @$GLOBALS['xoopsDB']->queryF($sql[0]);
                @$GLOBALS['xoopsDB']->queryF($sql[1]);
                redirect_header('main.php?op=' . _XCONTENT_URL_OP_MANAGE . '&fct=' . _XCONTENT_URL_FCT_BLOCKS, 7, _XCONTENT_AD_MSG_DELETE);
                break;
        }
    ...
    case _XCONTENT_URL_OP_COPY:
        switch ($fct) {
            ...
            default:
                ...
                redirect_header('main.php?op=' . _XCONTENT_URL_OP_MANAGE . '&fct=' . _XCONTENT_URL_FCT_XCONTENT, 7, sprintf(_XCONTENT_AD_MSG_COPY, $page));
                break;
            case _XCONTENT_URL_FCT_BLOCKS:
                if (empty($_POST['confirmed'])) {
                    xoops_cp_header();
                ...
                redirect_header('main.php?op=' . _XCONTENT_URL_OP_MANAGE . '&fct=' . _XCONTENT_URL_FCT_BLOCKS, 7, sprintf(_XCONTENT_AD_MSG_COPY, $page));
                break;
            case _XCONTENT_URL_FCT_CATEGORY:
                if (empty($_POST['confirmed'])) {
                    xoops_cp_header();
                ...
                redirect_header('main.php?op=' . _XCONTENT_URL_OP_MANAGE . '&fct=' . _XCONTENT_URL_FCT_CATEGORIES, 7, sprintf(_XCONTENT_AD_MSG_COPY, $page));
                break;
        }
    // no break
    case _XCONTENT_URL_OP_MANAGE:
        switch ($fct) {
            case _XCONTENT_URL_FCT_XCONTENT:
                ...
                $adminObject = Admin::getInstance();
                $adminObject->displayNavigation(basename($_SERVER['SCRIPT_NAME']) . '?op=' . $op . '&fct=' . $fct);
                $adminObject->addItemButton(_XCONTENT_XCONTENT_ADMENU2, 'main.php?op=' . _XCONTENT_URL_OP_ADD . '&fct=' . _XCONTENT_URL_FCT_XCONTENT, 'add', '');
            ...
            case _XCONTENT_URL_FCT_BLOCKS:
                ...
                $adminObject = Admin::getInstance();
                $adminObject->displayNavigation(basename($_SERVER['SCRIPT_NAME']) . '?op=' . $op . '&fct=' . $fct);
                $adminObject->addItemButton(_XCONTENT_XCONTENT_ADMENU6, 'main.php?op=' . _XCONTENT_URL_OP_ADD . '&fct=' . _XCONTENT_URL_FCT_BLOCKS, 'add', '');
                $adminObject->displayButton('left', '');
            ...
            case _XCONTENT_URL_FCT_CATEGORIES:
                ...
                $adminObject = Admin::getInstance();
                $adminObject->displayNavigation(basename($_SERVER['SCRIPT_NAME']) . '?op=' . $op . '&fct=' . $fct);
                $adminObject->addItemButton(_XCONTENT_XCONTENT_ADMENU4, 'main.php?op=' . _XCONTENT_URL_OP_ADD . '&fct=' . _XCONTENT_URL_FCT_CATEGORIES, 'add', '');
                $adminObject->displayButton('left', '');
    ...
    case _XCONTENT_URL_OP_PERMISSIONS:
        ...
        $adminObject = Admin::getInstance();
        $adminObject->displayNavigation(basename($_SERVER['SCRIPT_NAME']) . '?op=' . $op);
        //        $adminObject->displayNavigation(basename($_SERVER['SCRIPT_NAME']) . '?op=' . $op . '&fct=' . _XCONTENT_URL_FCT_TEMPLATE . '&mode=' . _XCONTENT_PERM_MODE_ALL);
        ...
        if (_XCONTENT_SECURITY_BASIC == $GLOBALS['xoopsModuleConfig']['security']) {
            echo '<option value="' . XOOPS_URL . '/modules/xcontent/admin/main.php?op=' . _XCONTENT_URL_OP_PERMISSIONS . '&fct=' . _XCONTENT_URL_FCT_TEMPLATE . '&mode=' . _XCONTENT_PERM_MODE_ALL . '"';
            ...
            echo '<option value="' . XOOPS_URL . '/modules/xcontent/admin/main.php?op=' . _XCONTENT_URL_OP_PERMISSIONS . '&fct=' . _XCONTENT_URL_FCT_XCONTENT . '&mode=' . _XCONTENT_PERM_MODE_VIEW . '"';
            ...
            echo '<option value="' . XOOPS_URL . '/modules/xcontent/admin/main.php?op=' . _XCONTENT_URL_OP_PERMISSIONS . '&fct=' . _XCONTENT_URL_FCT_CATEGORIES . '&mode=' . _XCONTENT_PERM_MODE_VIEW . '"';
            if (_XCONTENT_URL_FCT_CATEGORIES == $fct && _XCONTENT_PERM_MODE_VIEW == $_GET['mode']) {
                echo ' selected>' . _XCONTENT_PERM_VIEW_CATEGORY . '</option>';
            } else {
                echo '>' . _XCONTENT_PERM_VIEW_CATEGORY . '</option>';
            ...
            echo '<option value="' . XOOPS_URL . '/modules/xcontent/admin/main.php?op=' . _XCONTENT_URL_OP_PERMISSIONS . '&fct=' . _XCONTENT_URL_FCT_BLOCKS . '&mode=' . _XCONTENT_PERM_MODE_VIEW . '"';
            ...
            echo '<option value="' . XOOPS_URL . '/modules/xcontent/admin/main.php?op=' . _XCONTENT_URL_OP_PERMISSIONS . '&fct=' . _XCONTENT_URL_FCT_CATEGORIES . '&mode=' . _XCONTENT_PERM_MODE_EDIT . '"';
            ...
            echo '<option value="' . XOOPS_URL . '/modules/xcontent/admin/main.php?op=' . _XCONTENT_URL_OP_PERMISSIONS . '&fct=' . _XCONTENT_URL_FCT_XCONTENT . '&mode=' . _XCONTENT_PERM_MODE_EDIT . '"';
            ...
            echo '<option value="' . XOOPS_URL . '/modules/xcontent/admin/main.php?op=' . _XCONTENT_URL_OP_PERMISSIONS . '&fct=' . _XCONTENT_URL_FCT_BLOCKS . '&mode=' . _XCONTENT_PERM_MODE_EDIT . '"';
            ...
            echo '<option value="' . XOOPS_URL . '/modules/xcontent/admin/main.php?op=' . _XCONTENT_URL_OP_PERMISSIONS . '&fct=' . _XCONTENT_URL_FCT_XCONTENT . '&mode=' . _XCONTENT_PERM_MODE_ADD . '"';
                ...
                if ($GLOBALS['xoopsDB']->getRowsNum($result_view)) {
                    while (false !== ($myrow_view = $GLOBALS['xoopsDB']->fetchArray($result_view))) {
                        ...
                        $form_view               = new \XoopsGroupPermForm(
                            ...
                            . ucfirst($mode)
                            . '</span>',
                            'admin/main.php?op=permissions&fct=template&mode=all'
                        );
                    ...
                    if ($GLOBALS['xoopsDB']->getRowsNum($result_view)) {
                        while (false !== ($myrow_view = $GLOBALS['xoopsDB']->fetchArray($result_view))) {
                            ...
                            $form_view               = new \XoopsGroupPermForm(
                                ...
                                . "</h3><div id='toptable'><span style=\"color: #567; margin: 3px 0 0 0; font-size: small; display: block; \">"
                                . ucfirst($mode)
                                . "</span>, 'admin/main.php?op=permissions&fct=template&mode=all'"
                            );
                            $block_view[]            = $item_list_view;
                            foreach ($block_view as $itemlists) {
                                $form_view->addItem($itemlists['cid'], $itemlists['title']);
